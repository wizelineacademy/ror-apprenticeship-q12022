...
module Environment
  ...
  class Human
    ...
    define_method('set_personal_data') do |surname:, age:, country:, language:, marital_status:, children:|
      @personal_data = { surname: surname, age: age, country: country, language: language,
    ...
    define_method('set_professional_data') do |position:, occupation:, skills:, observations:|
      @professional_data = { position: position, occupation: occupation, skills: skills,
    ...
    class Worker < Human
      ...
      def initialize(name)
        super name: name
        @standard_shift = { id: @id, hours: 8, payment: 0.0, facility: '', status: nil}
        @extra_shift = { id: @id, hours: 8, payment: 0.0, facility: '', status: nil}
      end
    end
  end
end
